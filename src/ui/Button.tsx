const buttonVariants = {
  ...
  tertiary: `text-surface/60 px-6 py-2 rounded-md hover:bg-accent/30`,
  tertiaryActive: `text-surface px-6 py-2 rounded-md bg-accent/30`,
...
export default function Button({
  ...
  const baseStyles = `flex items-center justify-center gap-1 uppercase tracking-wider cursor-pointer`;
